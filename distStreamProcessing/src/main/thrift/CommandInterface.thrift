...
service CommandInterface{
	...
	oneway void CreateTask(1:string compName, 2:string topologyname ,3:string fullClassName, 4:int instanceId); #compmanager to nm
	...
	oneway void StartTopology(1:string sTopoloogy);
}
